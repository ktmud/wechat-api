...
//  }
// })
Client.INVALID_TOKEN = Client.prototype.INVALID_TOKEN = 40001
Client.INVALID_APPID = Client.prototype.INVALID_APPID = 40013

Client.prototype.init = function() {
  aliasProperty(this, 'access_token', 'token')
  aliasProperty(this, 'key', 'appid')

  // in case you have some batch operation waiting
...
Client.prototype._request = function(method, url, data, callback, refresh_tries) {
  ...
  function run() {
    ...
    req.end(function(err, res) {
      ...
      if (result && result.errcode == self.INVALID_TOKEN && refresh_tries) {
        refresh_tries -= 1
        return refresh(run)
      }
