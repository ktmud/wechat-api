...
Client.prototype._getUserInfo = api('GET', '/user/info')
Client.prototype.getUserInfo = function(params, callback) {
  if ('string' == typeof params) {
    // a shortcut for directly pass openid as params
    params = { openid: params }
  }
  return this._getUserInfo(params, callback)
}
